...
class _WebERPState extends State<WebViewScreen> {
  ...
  bool isLoading = true;
  String url = "https://rkjudicialacademy.com/dashboard/";
  // String url = "https://nutsby.com";
                      ...
                      child: InAppWebView(
                        ...
                        onReceivedHttpError: (controller, request, error) {
                          if (error.statusCode == 409) {
                            // Handle the 409 error, you might want to refresh the page or handle the session
                            controller.reload(); // Try reloading the page
                          }
                          pullToRefreshController?.endRefreshing();
                          setState(() {
                            isLoading = false;
